(function(q) {
  function t(t) {
    for (
      var e, a, v = t[0], r = t[1], s = t[2], m = 0, h = [];
      m < v.length;
      m++
    )
      (a = v[m]),
        ...
        (n[a] = 0);
    for (e in r) Object.prototype.hasOwnProperty.call(r, e) && (q[e] = r[e]);
    i && i(t);
    while (h.length) h.shift()();
    return o.push.apply(o, s || []), l();
  }
  function l() {
    for (var q, t = 0; t < o.length; t++) {
      for (var l = o[t], e = !0, v = 1; v < l.length; v++) {
        var r = l[v];
        0 !== n[r] && (e = !1);
      }
      e && (o.splice(t--, 1), (q = a((a.s = l[0]))));
    }
    return q;
  }
  var e = {},
  ...
  function a(t) {
    ...
    var l = (e[t] = { i: t, l: !1, exports: {} });
    return q[t].call(l.exports, l, l.exports, a), (l.l = !0), l.exports;
  }
  (a.m = q),
    (a.c = e),
    (a.d = function(q, t, l) {
      a.o(q, t) || Object.defineProperty(q, t, { enumerable: !0, get: l });
    }),
    (a.r = function(q) {
  ...
  var v = (window["webpackJsonp"] = window["webpackJsonp"] || []),
    r = v.push.bind(v);
  (v.push = t), (v = v.slice());
  for (var s = 0; s < v.length; s++) t(v[s]);
  var i = r;
  o.push([
    0,
  ...
  4360: function(q, t, l) {
    ...
    var e = l("2b0e"),
      n = l("2f62"),
      o = l("bfa9"),
      a = (l("4160"), l("b64b"), l("159b"), l("213f")),
      v = {
        state: Object(a["b"])(),
        mutations: {
          updateCombatData: function(q, t) {
            (q.encounter = t.encounter), (q.combatants = t.combatants);
          },
          resetCombatData: function(q) {
            var t = Object(a["b"])();
        ...
        getters: {
          inEncounter: function(q) {
            return (
              q.encounter.duration && q.combatants && q.combatants.length > 0
            );
          }
        }
      },
      r = (l("d3b7"), l("25f0"), l("740b")),
      s = {
        state: i,
        mutations: {
          update: function(q, t) {
          ...
          updatePrimaryPlayer: function(q, t) {
            q.primaryPlayer = t;
          }
        }
      };
    ...
    function h(q) {
      (q._foregroundColor = new r["TinyColor"](q.backgroundColor)
        .lighten(10)
        .toString()),
        (q._controlColor = new r["TinyColor"](q.backgroundColor)
          .lighten(70)
          .toString());
    }
    function c(q) {
      if (q.jobIcons)
        switch (((q._jobIconDisplay = "flex"), q.iconSize)) {
          case 1:
            q._iconSize = "1.5em";
            break;
          case 2:
      ...
      else q._jobIconDisplay = "none";
    }
    function w(q) {
      q.percentBar ? (q._percentBar = "block") : (q._percentBar = "none");
    }
    function g(q) {
      q.collapsed ? (q._mainDisplay = "none") : (q._mainDisplay = "flex");
    }
    function p(q) {
      q.percentBarRole
        ? (q.percentBarColor = "#484C4E")
        : (q.percentBarColor = "#12676c");
    }
    var T = l("5930"),
      d = l("63e5"),
      z = {
        ...
        getters: {
          ...
          digitSeps: function(q) {
            return q.digitSeps;
          },
          decimalSeps: function(q) {
            return q.decimalSeps;
          },
          additionalStats: function(q) {
            return q.additionalStats;
          },
          jobDetails: function(q) {
            return q.jobDetails;
          },
          menuIcon: function(q) {
            return q.menuIcon;
          },
          settingsIcon: function(q) {
            return q.settingsIcon;
          },
          openIcon: function(q) {
            return q.openIcon;
          },
          closeIcon: function(q) {
            return q.closeIcon;
          }
        }
      };
    ...
    t["a"] = new n["a"].Store({
      modules: { combatData: v, validValues: z, settings: s },
      plugins: [f.plugin]
    });
  },
  "641b": function(q, t, l) {
    ...
    var e = l("2bf7"),
      ...
      g = [
        { path: "/", component: e["a"] },
        { path: "/encounter", component: n["a"] },
        {
          path: "/settings",
          component: o["a"],
          children: [
            { path: "general", component: a["a"] },
            { path: "names", component: r["a"] },
            { path: "numbers", component: v["a"] },
            { path: "player-details", component: w["a"] },
            { path: "job-icons", component: s["a"] },
            { path: "percent-bar", component: i["a"] },
            { path: "percent-bar-you", component: c["a"] },
            { path: "percent-bar-role", component: h["a"] },
            { path: "advanced", component: m["a"] }
          ]
        },
        { path: "*", component: e["a"] }
      ];
  ...
  d3a4: function(q, t, l) {
    "use strict";
    l("4160"), l("d3b7"), l("ac1f"), l("466d"), l("159b"), l("ddb0");
    var e = l("2b0e"),
      n = l("a925");
    function o() {
      var q = l("49f8"),
        t = {};
      return (
        q.keys().forEach(function(l) {
          var e = l.match(/([A-Za-z0-9-_]+)\./i);
          if (e && e.length > 1) {
            var n = e[1];
            t[n] = q(l);
          }
...
//# sourceMappingURL=app~3d9b8e9e.99dca142.js.map
